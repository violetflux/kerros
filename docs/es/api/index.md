...
El Context solo contiene la instancia original y el primer Hook se suscribe con un selector. El propietario que crea la instancia sigue gestionando su inicio, parada, destrucción y acceso imperativo.

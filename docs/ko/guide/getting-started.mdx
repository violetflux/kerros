...
`createStore`는 컴포넌트 Hook, 대응하는 Provider, React 밖에서 커밋된 인스턴스를 읽는 명령형 getter를 반환합니다. Store 안에서는 `useState`, `useReducer`, Context, SDK Hook, custom Hook을 그대로 사용할 수 있습니다.

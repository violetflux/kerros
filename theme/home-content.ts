...
export const evidence: Record<string, HomeEvidence> = {
  zh: {
    title: '可信证据',
    items: [
      { title: '版本与 React 兼容', detail: '当前版本 0.3.1，peerDependencies 覆盖 React ^17.0.0 || ^18.0.0 || ^19.0.0。' },
  ...
  en: {
    ...
    items: [
      { title: 'Version and React compatibility', detail: 'Current version 0.3.1; peerDependencies cover React ^17.0.0 || ^18.0.0 || ^19.0.0.' },
  ...
  ja: {
    title: '信頼できる証拠',
    items: [
      { title: 'バージョンと React 互換性', detail: '現在のバージョンは 0.3.1、peerDependencies は React ^17.0.0 || ^18.0.0 || ^19.0.0 をカバーします。' },
  ...
  ko: {
    title: '신뢰할 수 있는 증거',
    items: [
      { title: '버전과 React 호환성', detail: '현재 버전은 0.3.1이며 peerDependencies는 React ^17.0.0 || ^18.0.0 || ^19.0.0을 지원합니다.' },
  ...
  de: {
    ...
    items: [
      { title: 'Version und React-Kompatibilität', detail: 'Aktuelle Version 0.3.1; die peerDependencies decken React ^17.0.0 || ^18.0.0 || ^19.0.0 ab.' },
  ...
  fr: {
    ...
    items: [
      { title: 'Version et compatibilité React', detail: 'Version actuelle 0.3.1 ; les peerDependencies couvrent React ^17.0.0 || ^18.0.0 || ^19.0.0.' },
  ...
  es: {
    ...
    items: [
      { title: 'Versión y compatibilidad con React', detail: 'Versión actual 0.3.1; las peerDependencies cubren React ^17.0.0 || ^18.0.0 || ^19.0.0.' },
